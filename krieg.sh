...
$buildshit && [ -z "$version" ] && { EchoRed "NO Version number specified. Naming zips as TEST}"; version="TEST"; }
$syncshit && [ -z "$depth" ] && EchoRed "Depth not specified. Pulling everything"
